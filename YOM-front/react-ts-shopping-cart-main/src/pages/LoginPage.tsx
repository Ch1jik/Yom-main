          ...
          <div>
            ...
            <div className="myads-tab-panels">
              ...
              >
                ...
                <h1 className='loginPagetitle'>З поверненням</h1>
                <h3 className='loginPagedescription'>Будь ласка, введіть свої дані.</h3>
                ...
                <form onSubmit={handleLoginSubmit}>
                  ...
                  <div className="login-input-section ">
                    <div className='loginregister-input-names'>Електронна адресса</div>
                    <input
                      type="email"
                      placeholder='Логін'
                  ...
                  <div className="login-input-section ">
                    <div className='loginregister-input-names'>Пароль</div>
                    <input
                      type="password"
                      placeholder='Пароль'
                      className="login-register-inputs"
                  ...
                  <div>
                    <button type="submit" className="reg-buttons">Логін</button>
                    <div className='reg-buttons-forgot'>
                      <a className='remove-style-from-link' href="#" onClick={() => navigate('/forgot-password')}>Забули пароль?</a>
                    </div>
                  </div>
                </form>
              ...
              >
                <h1 className='loginPagetitle'>Створення аккаунту</h1>
                <h1 className='loginPagedescription'>Будь ласка, введіть свої дані.</h1>
                ...
                <form onSubmit={handleRegistrationSubmit}>
                  ...
                  <button type="submit" className="reg-buttons">Зареєструватися</button>
                </form>
              </div>
            </div>
          </div>
